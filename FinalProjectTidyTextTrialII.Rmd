...
We then visualize the most important transactions within this data, items that have 15% support or greater.

```{r, message=F, cache=T, warning=F}
# itemFrequencyPlot(surface.trans[, itemFrequency(surface.trans) > 0.15],cex.names = 0.8,main="Items, Support >= 15%", xlab="Transactions", ylab="Item Frequency (Relative)",col=brewer.pal(n=8, name= "Dark2"))
```

We then look at the rules that associate these variables together.
...
We found a set of 10,405 rules that meet our requirements of support >= 0.1% and confidence >= 50%.
